...
export const THEME_CONFIG = 'hanzo.analytics.theme';
export const DASHBOARD_CONFIG = 'hanzo.analytics.dashboard';
export const LAST_TEAM_CONFIG = 'hanzo.analytics.last-team';
export const VERSION_CHECK = 'hanzo.analytics.version-check';
export const SHARE_TOKEN_HEADER = 'x-iam-share-token';
export const HOMEPAGE_URL = 'https://analytics.hanzo.ai';
export const DOCS_URL = 'https://analytics.hanzo.ai/docs';
