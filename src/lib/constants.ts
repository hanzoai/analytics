...
export const AUTH_TOKEN = 'analytics.auth';
export const LOCALE_CONFIG = 'analytics.locale';
export const TIMEZONE_CONFIG = 'analytics.timezone';
export const DATE_RANGE_CONFIG = 'analytics.date-range';
export const THEME_CONFIG = 'analytics.theme';
export const DASHBOARD_CONFIG = 'analytics.dashboard';
export const VERSION_CHECK = 'analytics.version-check';
export const SHARE_TOKEN_HEADER = 'x-analytics-share-token';
export const HOMEPAGE_URL = 'https://hanzo.ai';
export const REPO_URL = 'https://github.com/hanzoai/analytics';
export const UPDATES_URL = 'https://api.hanzo.ai/v1/updates';
export const TELEMETRY_PIXEL = 'https://i.hanzo.ai/a.png';
