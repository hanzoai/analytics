...
export type AnalyticsTracker = {
  track: {
     ...
     *
     * @example ```
     * analytics.track('signup-button', { name: 'newsletter', id: 123 });
     * ```
     */
     ...
     *
     * @example ```
     * analytics.track({ website: 'e676c9b4-11e4-4ef1-a4d7-87001773e9f2', url: '/home', title: 'Home page' });
     * ```
     */
     ...
     *
     * @example ```
     * analytics.track((props) => ({ ...props, url: path }));
     * ```
     */
