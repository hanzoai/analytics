-- Create Event
CREATE TABLE analytics.website_event_new
(
    website_id UUID,
    session_id UUID,
    visit_id UUID,
...
-- stats hourly
CREATE TABLE analytics.website_event_stats_hourly_new
(
    website_id UUID,
    session_id UUID,
    visit_id UUID,
...
CREATE MATERIALIZED VIEW analytics.website_event_stats_hourly_mv_new
TO analytics.website_event_stats_hourly_new
AS
SELECT
    website_id,
    session_id,
...
FROM analytics.website_event_new
GROUP BY website_id,
    session_id,
    visit_id,
    hostname,
...
-- projections
ALTER TABLE analytics.website_event_new
ADD PROJECTION website_event_url_path_projection (
SELECT * ORDER BY toStartOfDay(created_at), website_id, url_path, created_at
);

ALTER TABLE analytics.website_event_new MATERIALIZE PROJECTION website_event_url_path_projection;
...
ALTER TABLE analytics.website_event_new MATERIALIZE PROJECTION website_event_referrer_domain_projection;

-- migration
INSERT INTO analytics.website_event_new
...
-- rename tables
RENAME TABLE analytics.website_event TO analytics.website_event_old;
RENAME TABLE analytics.website_event_new TO analytics.website_event;

RENAME TABLE analytics.website_event_stats_hourly TO analytics.website_event_stats_hourly_old;
RENAME TABLE analytics.website_event_stats_hourly_new TO analytics.website_event_stats_hourly;

RENAME TABLE analytics.website_event_stats_hourly_mv TO analytics.website_event_stats_hourly_mv_old;
RENAME TABLE analytics.website_event_stats_hourly_mv_new TO analytics.website_event_stats_hourly_mv;
