describe('Website tests', () => {
  ...
  it('Add a website', () => {
    ...
    cy.contains('td', 'Add test').should('exist');
    cy.contains('td', 'addtest.com').should('exist');

    // clean-up data
    cy.getDataTest('link-button-edit').first().click();
    cy.getDataTest('text-field-websiteId').should('exist');
  ...
  it('Edit a website', () => {
    ...
    // edit website
    cy.getDataTest('link-button-edit').first().click();
    cy.getDataTest('input-name').should('exist');
    ...
    cy.visit('/websites');
    cy.contains(/Updated website/i).should('not.exist');
  });
